...
import { ArrowLeft, Send, FileSignature, Star } from "lucide-react";
...
import type { PerformanceReviewItem, ReviewStatus } from "@/lib/performanceTypes";

export const reviewStatusBadgeVariant: Record<ReviewStatus, "default" | "secondary" | "outline"> = {
  inprogress: "outline",
  draft: "secondary",
  completed: "default",
  overdue: "outline",
...
export function PerformanceReviewDetail({ review, consultantReviews, onBack, onSaved }: PerformanceReviewDetailProps) {
